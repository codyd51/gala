...
ld build/entry.o -U _main -U start -static -o build/shellcode_within_kernelcache_packed
python3 ../dump_shellcode.py build/shellcode_within_kernelcache_packed build/shellcode_within_kernelcache_shellcode
